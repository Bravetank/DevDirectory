...
@Controller //Shows this is a Controller class
public class DevController {
    ...
    public String listAllDevs(ModelMap modelMap) {
        ...
        return "home"; //This is enough for Thymeleaf View Resolver to figure out which html page is needed
    }
    ...
    public String devDetails(@PathVariable String name, ModelMap modelMap){
        //First retrieve a Developer object from the DeveloperRepository that you can return to the View
...
//See DeveloperRepository for what happens with this method.
        ...
        //Second - make object available to View. Need to add it to a Model Map.
        //Has to be added as an argument to method (completed above)
        //This means when this method called Spring passes in an instance of a model map into this parameter.
